...
import 'package:mimebot/features/password/view/forgot_password.dart';
...
class ForgotOtpPage extends StatefulWidget {
  ...
  const ForgotOtpPage({super.key, required this.emailId});
                    ...
                    child: Material(
                      ...
                      child: Ink(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await otpController
                                .verifyOtp(emailId: widget.emailId)
                                .then((_) {
                              if (otpController.otpModel.value.status == true) {
