class ApiEndPoints {
  static const String baseURL = 'http://restapi.mimebot.in/UserApi/';
  static const String apiToken = "mimebot@123";
  ...
  static const String savedVideo = "saved_videos.php";
  static const String checkOtp = "checkotp.php";
  static const String updatePassword = "update_password.php";
  static const String forgotPassword = "forgotPassword.php";
  static const String ongoingScreen = "ongoing_screen.php";
  static const String addSavedVideo = 'add_to_save.php';
}
